...
#import "BackButton.h"
@interface SecondFunctionBaseViewControllerEx ()
@property (strong,nonatomic) BackButton *returnButton;
@end

@implementation SecondFunctionBaseViewControllerEx
...
@synthesize functionTitle, returnButton;
