...
//    {
//        SecondBaseViewControllerEx *schoolHomeView = [[SecondBaseViewControllerEx alloc] init];
//        schoolHomeView.m_arData = [[NSArray alloc]initWithObjects:@"学校简介",@"师资力量",@"招生信息",@"学校荣誉",@"学校动态",nil];
//        schoolHomeView.m_image = [[NSArray alloc]initWithObjects:@"main_notice_announcement.png", @"second_festival_greetings.png", @"second_birthday_blessing",@"second_birthday_blessing",@"second_birthday_blessing", nil];
//        schoolHomeView.htmlNames = [[NSArray alloc]initWithObjects:@"school.html",@"teacher.html",@"recruitstudentslist.html",@"honer.html",@"dynamiclist.html",nil];
//        schoolHomeView.htmlDirectorys = [[NSArray alloc]initWithObjects:@"www/model/SchoolSummary",@"www/model/SchoolSummary",@"www/model/SchoolSummary",@"www/model/SchoolSummary",@"www/model/SchoolSummary",nil];
//        [schoolHomeView.returnButton setTitle:@"学校主页" forState:UIControlStateNormal];
//        __weak SecondBaseViewControllerEx* weadSelf = schoolHomeView;
//        schoolHomeView.btnClickedBlock = ^(NSInteger index){
//            SecondFunctionBaseViewControllerEx* secondFunVC = [[SecondFunctionBaseViewControllerEx alloc] init];
//            secondFunVC.htmlName = weadSelf.htmlNames[index];
//            secondFunVC.htmlDirectory = weadSelf.htmlDirectorys[index];
//            secondFunVC.functionTitle = weadSelf.m_arData[index];
...
//        SecondBaseViewControllerEx *secondVC = [[SecondBaseViewControllerEx alloc] init];
//        if ([UserManager shareController].UserType == PARENT){
//            secondVC.m_arData = [[NSArray alloc]initWithObjects:@"当日考勤",@"考勤查询",nil];
//            secondVC.m_image = [[NSArray alloc]initWithObjects:@"main_notice_announcement.png", @"second_festival_greetings.png",nil];
//            secondVC.htmlNames = [[NSArray alloc]initWithObjects:@"attendanceTodayForParent.html",@"attendanceQueryForParent.html",nil];
//            secondVC.htmlDirectorys = [[NSArray alloc]initWithObjects:@"www/model/CheckAttendan",@"www/model/CheckAttendan",nil];
//        }else{
//            secondVC.m_arData = [[NSArray alloc]initWithObjects:@"当日考勤",@"考勤查询",@"历史考勤统计",@"请假列表",nil];
//            secondVC.m_image = [[NSArray alloc]initWithObjects:@"main_notice_announcement.png", @"second_festival_greetings.png",@"main_notice_announcement.png", @"second_festival_greetings.png",nil];
//            secondVC.htmlNames = [[NSArray alloc]initWithObjects:@"attendanceDaily.html",@"attendanceQuery.html",@"accendanceHistoryStatistics.html",@"request_watch.html",nil];
//            secondVC.htmlDirectorys = [[NSArray alloc]initWithObjects:@"www/model/CheckAttendan",@"www/model/CheckAttendan",@"www/model/CheckAttendan",@"www/model/CheckAttendan",nil];
//        }
//        [secondVC.returnButton setTitle:@"考勤信息" forState:UIControlStateNormal];
//        __weak SecondBaseViewControllerEx* weadSelf = secondVC;
//        secondVC.btnClickedBlock = ^(NSInteger index){
//            SecondFunctionBaseViewControllerEx* secondFunVC = [[SecondFunctionBaseViewControllerEx alloc] init];
//            secondFunVC.htmlName = weadSelf.htmlNames[index];
...
//        SecondBaseViewControllerEx *secondVC = [[SecondBaseViewControllerEx alloc] init];
//        if ([UserManager shareController].UserType == PARENT){
//            secondVC.m_arData = [[NSArray alloc]initWithObjects:@"体温记录",@"体温趋势",nil];
//            secondVC.m_image = [[NSArray alloc]initWithObjects:@"main_notice_announcement.png", @"second_festival_greetings.png",nil];
//            secondVC.htmlNames = [[NSArray alloc]initWithObjects:@"bodyTempQueryForParent.html",@"tempTrendParent.html",nil];
//            secondVC.htmlDirectorys = [[NSArray alloc]initWithObjects:@"www/model/BodyTemp",@"www/model/BodyTemp",nil];
//        }else{
//            secondVC.m_arData = [[NSArray alloc]initWithObjects:@"体温告警",@"体温记录",@"体温趋势",nil];
//            secondVC.m_image = [[NSArray alloc]initWithObjects:@"main_notice_announcement.png", @"second_festival_greetings.png",@"second_festival_greetings.png",nil];
//            secondVC.htmlNames = [[NSArray alloc]initWithObjects:@"bodyTempAlarm.html",@"bodyTempQuery.html",@"tempTrend.html",nil];
//            secondVC.htmlDirectorys = [[NSArray alloc]initWithObjects:@"www/model/BodyTemp",@"www/model/BodyTemp",@"www/model/BodyTemp",nil];
//        }
//        
//        [secondVC.returnButton setTitle:@"体温管理" forState:UIControlStateNormal];
//        __weak SecondBaseViewControllerEx* weadSelf = secondVC;
//        secondVC.btnClickedBlock = ^(NSInteger index){
//            SecondFunctionBaseViewControllerEx* secondFunVC = [[SecondFunctionBaseViewControllerEx alloc] init];
//            secondFunVC.htmlName = weadSelf.htmlNames[index];
...
//        SecondBaseViewControllerEx *secondVC = [[SecondBaseViewControllerEx alloc] init];
//        if ([UserManager shareController].UserType == PARENT){
//            secondVC.m_arData = [[NSArray alloc]initWithObjects:@"当日作业",@"作业查询",nil];
//            secondVC.m_image = [[NSArray alloc]initWithObjects:@"main_notice_announcement.png", @"second_festival_greetings.png",nil];
//            secondVC.htmlNames = [[NSArray alloc]initWithObjects:@"homeworkTodayForParent.html",@"homeworkQueryForParent.html",nil];
//            secondVC.htmlDirectorys = [[NSArray alloc]initWithObjects:@"www/model/HomeWork",@"www/model/HomeWork",nil];
//        }else{
//            secondVC.m_arData = [[NSArray alloc]initWithObjects:@"作业发布",@"作业查询",nil];
//            secondVC.m_image = [[NSArray alloc]initWithObjects:@"main_notice_announcement.png", @"second_festival_greetings.png",nil];
//            secondVC.htmlNames = [[NSArray alloc]initWithObjects:@"homeworkPublish.html",@"homeworkQuery.html",nil];
//            secondVC.htmlDirectorys = [[NSArray alloc]initWithObjects:@"www/model/HomeWork",@"www/model/HomeWork",nil];
//        }
//        
//        [secondVC.returnButton setTitle:@"家庭作业" forState:UIControlStateNormal];
//        __weak SecondBaseViewControllerEx* weadSelf = secondVC;
//        secondVC.btnClickedBlock = ^(NSInteger index){
//            SecondFunctionBaseViewControllerEx* secondFunVC = [[SecondFunctionBaseViewControllerEx alloc] init];
//            secondFunVC.htmlName = weadSelf.htmlNames[index];
...
//    {
//        SecondBaseViewControllerEx *secondVC = [[SecondBaseViewControllerEx alloc] init];
//        secondVC.m_arData = [[NSArray alloc]initWithObjects:@"在籍学生",@"学籍查询",@"学籍统计",nil];
//        secondVC.m_image = [[NSArray alloc]initWithObjects:@"main_notice_announcement.png", @"second_festival_greetings.png",@"main_notice_announcement.png",nil];
//        secondVC.htmlNames = [[NSArray alloc]initWithObjects:@"onDutyStudent.html",@"studentQuery.html",@"StudentStatisticsQuery.html",nil];
//        secondVC.htmlDirectorys = [[NSArray alloc]initWithObjects:@"www/model/StudentManagement",@"www/model/StudentManagement",@"www/model/StudentManagement",nil];
//        [secondVC.returnButton setTitle:@"学籍管理" forState:UIControlStateNormal];
//        __weak SecondBaseViewControllerEx* weadSelf = secondVC;
//        secondVC.btnClickedBlock = ^(NSInteger index){
//            SecondFunctionBaseViewControllerEx* secondFunVC = [[SecondFunctionBaseViewControllerEx alloc] init];
//            secondFunVC.htmlName = weadSelf.htmlNames[index];
...
////        }
////        
////        [secondVC.returnButton setTitle:@"教学管理" forState:UIControlStateNormal];
////        __weak SecondBaseViewControllerEx* weadSelf = secondVC;
////        secondVC.btnClickedBlock = ^(NSInteger index){
////            SecondFunctionBaseViewControllerEx* secondFunVC = [[SecondFunctionBaseViewControllerEx alloc] init];
////            secondFunVC.htmlName = weadSelf.htmlNames[index];
...
//        if ([[UserManager shareController] UserType] == PARENT) {
//            SecondBaseViewControllerEx *secondVC = [[SecondBaseViewControllerEx alloc] init];
//            secondVC.m_arData = [[NSArray alloc]initWithObjects:@"意见反馈",@"反馈列表",nil];
//            secondVC.m_image = [[NSArray alloc]initWithObjects:@"main_notice_announcement.png", @"second_festival_greetings.png",nil];
//            secondVC.htmlNames = [[NSArray alloc]initWithObjects:@"feedback-add.html",@"feedback-list.html",nil];
//            secondVC.htmlDirectorys = [[NSArray alloc]initWithObjects:@"www/model/Feedback",@"www/model/Feedback",nil];
//            [secondVC.returnButton setTitle:@"意见反馈" forState:UIControlStateNormal];
//            __weak SecondBaseViewControllerEx* weadSelf = secondVC;
//            secondVC.btnClickedBlock = ^(NSInteger index){
//                SecondFunctionBaseViewControllerEx* secondFunVC = [[SecondFunctionBaseViewControllerEx alloc] init];
//                secondFunVC.htmlName = weadSelf.htmlNames[index];
...
//    {
//        SecondBaseViewControllerEx *secondVC = [[SecondBaseViewControllerEx alloc] init];
//        secondVC.m_arData = [[NSArray alloc]initWithObjects:@"请假申请",@"请假查看",nil];
//        secondVC.m_image = [[NSArray alloc]initWithObjects:@"main_notice_announcement.png", @"second_festival_greetings.png",nil];
//        secondVC.htmlNames = [[NSArray alloc]initWithObjects:@"parent_request.html",@"parent_watch.html",nil];
//        secondVC.htmlDirectorys = [[NSArray alloc]initWithObjects:@"www/model/CheckAttendan",@"www/model/CheckAttendan",nil];
//        [secondVC.returnButton setTitle:@"请假管理" forState:UIControlStateNormal];
//        __weak SecondBaseViewControllerEx* weadSelf = secondVC;
//        secondVC.btnClickedBlock = ^(NSInteger index){
//            SecondFunctionBaseViewControllerEx* secondFunVC = [[SecondFunctionBaseViewControllerEx alloc] init];
//            secondFunVC.htmlName = weadSelf.htmlNames[index];
...
//            [secondFunVC.viewcontroller addJavascriptInterfaces:interface WithName:@"JsInterface"];
//            CheckAttendan* checkAttendan = [CheckAttendan new];
//            [secondFunVC.viewcontroller addJavascriptInterfaces:checkAttendan WithName:@"CheckAttendan"];            [secondFunVC InitFunctionView];
//            [weadSelf presentModalViewController:secondFunVC animated:YES];
//        };
//        [secondVC InitWithData];
//        
...
//        {
//            SecondBaseViewControllerEx *secondVC = [[SecondBaseViewControllerEx alloc] init];
//            secondVC.m_arData = [[NSArray alloc]initWithObjects:@"发布通知",@"通知列表",nil];
//            secondVC.m_image = [[NSArray alloc]initWithObjects:@"main_notice_announcement.png", @"second_festival_greetings.png",nil];
//            secondVC.htmlNames = [[NSArray alloc]initWithObjects:@"notifyPublish.html",@"notifyQuery.html",nil];
//            secondVC.htmlDirectorys = [[NSArray alloc]initWithObjects:@"www/model/Notify",@"www/model/Notify",nil];
//            [secondVC.returnButton setTitle:@"家校互动" forState:UIControlStateNormal];
//            __weak SecondBaseViewControllerEx* weadSelf = secondVC;
//            secondVC.btnClickedBlock = ^(NSInteger index){
//                SecondFunctionBaseViewControllerEx* secondFunVC = [[SecondFunctionBaseViewControllerEx alloc] init];
//                secondFunVC.htmlName = weadSelf.htmlNames[index];
