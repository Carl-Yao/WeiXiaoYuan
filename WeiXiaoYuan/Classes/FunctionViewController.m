...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        allFunctionsDic = @{@"2101":@{FUNC_IMG_KEY:@"学校简介.png",
                                      FUNC_TITLE_KEY:@"学校简介",
                                      FUNC_HTML_KEY:@"school.html",
                                      FUNC_DIRECTORY_KEY:@"www/model/SchoolSummary"},
                            @"2102":@{FUNC_IMG_KEY:@"师资力量.png",
                                      FUNC_TITLE_KEY:@"师资力量",
                                      FUNC_HTML_KEY:@"teacher.html",
                                      FUNC_DIRECTORY_KEY:@"www/model/SchoolSummary"},
                            @"2103":@{FUNC_IMG_KEY:@"招生信息.png",
                                      FUNC_TITLE_KEY:@"招生信息",
                            ...
                            @"2207":@{FUNC_IMG_KEY:@"main_student_status_management.png",
                                      FUNC_TITLE_KEY:@"老师当日考勤",
                                      FUNC_HTML_KEY:@"attendanceDaily_teacher.html",
                                      FUNC_DIRECTORY_KEY:@"www/model/CheckAttendan"},
                            @"2208":@{FUNC_IMG_KEY:@"main_student_status_management.png",
                                      FUNC_TITLE_KEY:@"老师考勤查询",
                                      FUNC_HTML_KEY:@"attendanceQuery_teacher.html",
                                      FUNC_DIRECTORY_KEY:@"www/model/CheckAttendan"},
                            @"2209":@{FUNC_IMG_KEY:@"main_student_status_management.png",
                                      FUNC_TITLE_KEY:@"老师考勤统计",
                                      FUNC_HTML_KEY:@"accendanceHistoryStatistics_teacher.html",
                                      FUNC_DIRECTORY_KEY:@"www/model/CheckAttendan"},
                            ...
                            @"2801":@{FUNC_IMG_KEY:@"main_student_status_management.png",
                                      FUNC_TITLE_KEY:@"体检记录",
                                      FUNC_HTML_KEY:@"physicalExamRecord.html",
                                      FUNC_DIRECTORY_KEY:@"www/model/Health"},
                            
                            @"2802":@{FUNC_IMG_KEY:@"main_student_status_management.png",
                                      FUNC_TITLE_KEY:@"体检记录",
                                      FUNC_HTML_KEY:@"physicalExamRecordForParent.html",
                                      FUNC_DIRECTORY_KEY:@"www/model/Health"},

                            @"2803":@{FUNC_IMG_KEY:@"main_student_status_management.png",
                                      FUNC_TITLE_KEY:@"体检分析",
                                      FUNC_HTML_KEY:@"physicalExamAnalysis.html",
                                      FUNC_DIRECTORY_KEY:@"www/model/Health"},
                            @"2804":@{FUNC_IMG_KEY:@"main_student_status_management.png",
                                      FUNC_TITLE_KEY:@"体检分析",
                                  FUNC_HTML_KEY:@"physicalExamAnalysisForParent.html",
                                      FUNC_DIRECTORY_KEY:@"www/model/Health"},
                            
                            @"2805":@{FUNC_IMG_KEY:@"main_student_status_management.png",
                                      FUNC_TITLE_KEY:@"成长树",
                                      FUNC_HTML_KEY:@"growthTree.html",
                                      FUNC_DIRECTORY_KEY:@"www/model/GrowthTree"},
                            @"2806":@{FUNC_IMG_KEY:@"main_student_status_management.png",
                                      FUNC_TITLE_KEY:@"当周食谱",
                                      FUNC_HTML_KEY:@"foodStatistics.html",
                                      FUNC_DIRECTORY_KEY:@"www/model/FoodManagement"}
                            ,
                            @"2901":@{FUNC_IMG_KEY:@"main_student_status_management.png",
                                      FUNC_TITLE_KEY:@"发布通知",
                                      FUNC_HTML_KEY:@"notifyPublish.html",
                                      FUNC_DIRECTORY_KEY:@"www/model/Notify"},
                            @"2902":@{FUNC_IMG_KEY:@"main_student_status_management.png",
                                      FUNC_TITLE_KEY:@"通知列表",
                                      FUNC_HTML_KEY:@"notifyQuery.html",
                                      FUNC_DIRECTORY_KEY:@"www/model/Notify"},
                            @"3501":@{FUNC_IMG_KEY:@"main_student_status_management.png",
                                      FUNC_TITLE_KEY:@"教育资讯",
                                      FUNC_HTML_KEY:@"newslist.html",
                                      FUNC_DIRECTORY_KEY:@"www/model/EduNews"},
                            @"3602":@{FUNC_IMG_KEY:@"main_student_status_management.png",
                                      FUNC_TITLE_KEY:@"反馈列表",
                                      FUNC_HTML_KEY:@"feedback-list.html",
                                      FUNC_DIRECTORY_KEY:@"www/model/Feedback"},
                            @"3601":@{FUNC_IMG_KEY:@"main_student_status_management.png",
                                      FUNC_TITLE_KEY:@"意见反馈",
                                      FUNC_HTML_KEY:@"feedback-add.html",
                                      FUNC_DIRECTORY_KEY:@"www/model/Feedback"},
                            @"3701":@{FUNC_IMG_KEY:@"main_student_status_management.png",
                                      FUNC_TITLE_KEY:@"请假申请",
                                      FUNC_HTML_KEY:@"parent_request.html",
                                      FUNC_DIRECTORY_KEY:@"www/model/CheckAttendan"},
                            @"3702":@{FUNC_IMG_KEY:@"main_student_status_management.png",
                                      FUNC_TITLE_KEY:@"请假查看",
                                      FUNC_HTML_KEY:@"parent_watch.html",
                                      FUNC_DIRECTORY_KEY:@"www/model/CheckAttendan"}
                            };
    }
    return self;
...
- (void)btnClicked:(id)sender event:(id)event
{
    ...
    for (int i = 0; i < [funcList count];i++) {
        ...
        [secondVC.m_image addObject:[dic objectForKey:FUNC_TITLE_KEY]];
